...
function Carousel(carousel, options) {
    ...
    function createStr(imgUrl) {
        var str = '<figure style="width:2rem;transform:rotateY({0}deg) translateZ({1});position:absolute;">' + '<img src="{2}" style="width:100%;height:100%;transform:scale(1.5, 1.5);">' + '</figure>';
     ...
     * @return {[type]}         [description]
     */
    this.palyVideo = function(playingCB, callback) {
        //索引从0开始
        var index = currIndex 
